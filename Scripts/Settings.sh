...
#删除冲突插件
rm -rf $(find ./feeds/luci/ -type d -iregex ".*\(argon\|design\|helloworld\|homebridger\|homeproxy\|openclash\|passwall\|mosdns\|smartdns\).*")
#修改默认主题
...
#sed -i 's/KERNEL_PATCHVER:=5.15/KERNEL_PATCHVER:=6.1/g' target/linux/mediatek
